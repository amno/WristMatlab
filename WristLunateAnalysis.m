...
%dicomRotRemoveEdge2=removeDicomEdges(dicomRotate2); %original
dicomRotRemoveEdge2=RemoveDicomEdges2(dicomRotate2); %modifications
            ...
            % pixel-value cross-sections along line segments
                    ...
                    %profileDicom2=improfile(dicomRotRemoveEdge2,AxisX,AxisY,700);
