...
if abs(cLunate-cMaxPixels)>150
    Xray_LPF                            = imfilter(Xray,gaussF).*(1-maxPixels).*Xray_border;
else
    Xray_LPF                            = imfilter(Xray,gaussF).*Xray_border;
end
...
gaussF=[35 1 1];
armProfile_mean2                        = imfilter(armProfile_mean,gaussF);
armProfile_min2                         = imfilter(armProfile_min, gaussF);
armProfile_max2                         = imfilter(armProfile_max, gaussF);
