...
baseDir                             = 'C:\Users\aczf102\OneDrive - City, University of London\Documents\MATLAB\DICOM_Karen\';
CXrayDir                            = dir(strcat(baseDir,'*_PA_*.mat'));
%TDir                                = dir(baseDir);   
%ADir                                = 'C:\Users\aczf102\Documents\MATLAB\DICOM_Karen\A*_PA_*.mat'  
%ADir = 'C:\Users\aczf102\Documents\MATLAB\DICOM_Karen\ANON3501_PATIENT_PA_124.mat'
numXrays                           = size(CXrayDir,1);
%numXrays                            = size(ADir,1);  %array Dimension

CXrayDir 
results(numXrays,50)=0;
displayData =0; % this is parameter to show Xray Image, where 0 to not show, 1 for show data
for k=1:40 
    try
    %k=19;
    clear stats
    ...
    %currentFile                     = ADir(k).name;
%    clear                             Xray*  LM_Y LM_X Corti* Trabec* Combined
    currentData                     = load(strcat(baseDir,CXrayDir(k).name))
...
load('C:\Users\aczf102\OneDrive - City, University of London\Documents\MATLAB\DICOM_Karen\FractureDirectory.mat'); 
